...
public class Position implements Parcelable {
    ...
    protected Position(Parcel in) {
        ...
        this.deviceId = ((Long) in.readValue((Integer.class.getClassLoader())));
        this.type = in.readValue((Object.class.getClassLoader()));
